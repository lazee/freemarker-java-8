...
/**
 * {@link TimezoneStrategy} which always transforms the input {@link ZoneId} to the {@link ZoneId} provided by
 * {@link Environment#getCurrentEnvironment()}{@link Environment#getTimeZone() .getTimeZone()}.<br>
 * <br>
...
public enum EnvironmentTimezoneStrategy implements TimezoneStrategy {
    ...
    /**
     * {@inheritDoc} Must always be called inside a template processing tread. Otherwise a {@link IllegalStateException} is thrown.
     * 
