...
Unfortunately FreeMarker doesn't support formatting the output of these classes, and there are no implementations worked on at the momen (http://freemarker.org/contribute.html).
